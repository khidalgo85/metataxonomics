...
Ao finalizar você terá dois objetos principais: i) tabela de frequências (`sequence.table.nochim`) e ii) taxonomia (`taxa.assig`), os quais serão usados nas análises *downstream.* 
